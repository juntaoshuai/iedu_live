	...
	<div class="area_video" v-bind:style="{backgroundImage:'url('+room.backgroundUrl+')'}">
	   ...
	   <!-- 图集轮播-->
		...
		<div class="video_content" v-if="model == 9">
			<video  v-bind:src="reviewArr[rindex].mp4Url" v-show="isPlaying" v-on:playing="playing" webkit-playsinline playsinline autoplay controls v-on:ended="changes(rindex,this)"></video>
		</div>
